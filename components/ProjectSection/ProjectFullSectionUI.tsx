        ...
        <motion.div
            ...
            {features?.content}
            {
                ...
                <motion.div
                    ...
                    className="absolute flex items-center gap-1 justify-center w-full h-full bg-neutral-600/40 dark:bg-neutral-600/30  rounded-xl inset-0 ">

                    {
                        features.githubLink &&
                        <div className="bg-white dark:bg-neutral-900 flex items-center justify-center border-[1px] border-black dark:border-neutral-400/40 p-2  rounded-full">
                            <a href={`${features?.githubLink}`}><LuGithub size={20} /></a>
                        </div>
                    }
                    {
                        features.webLink &&
                        <div className="bg-white dark:bg-neutral-900 border-[1px] flex items-center justify-center border-black dark:border-neutral-400/40 p-2  rounded-full">
