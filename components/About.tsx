...
export default function About(){
    ...
    return <section id="about">
        ...
        <p className="text-sm  lg:text-md text-justify mt-2   dark:text-neutral-400/60">I was born and raised up in <a href="https://maps.app.goo.gl/LXdsTrU1xmTiWWv28" className="underline font-bold">Jalandhar,Punjab India. </a>
         I'm passionate about building effective & impactful products that leverage technology to make a difference.I actively share my work on <a href="https://github.com/taranpreet26-singh" className="underline font-bold">Github</a> and <a href="https://www.linkedin.com/in/taranpreet-singh-57185a1a0/" className="underline font-bold">LinkedIn</a>. Additionally , I'm always curious about Web3 <span className="cursor-pointer" onClick={()=>{setShowTextStatus(true)}}>{!showAllText && `(show more...)`}</span>
          {
